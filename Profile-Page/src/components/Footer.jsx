...
const Footer = () => (
    <footer className="footer">
        <div className="container">
            <div className="row">
                <a href="index-particles.html" className="effect footer-title">Norman</a>
                ...
                <p className="copy-text">Imozar © 2018. all right reserved, designed by <strong><a href="https://themeforest.net/user/phydev" target="_blank">PhyDev</a></strong>.</p>
            </div> 
        </div> 
    </footer>
)
